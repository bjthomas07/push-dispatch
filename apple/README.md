...
Add the repository directly in Xcode or Package.swift. While it is private, the
build machine needs GitHub repository access. Pin a reviewed commit until release
tags are published:
